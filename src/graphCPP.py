...
def getmSST():
    ...
    with open('mSSTCPP_results.txt', 'r') as archivo:
...
def getmSNFS1():
    # Abre el archivo de texto en modo lectura
    with open('mSNFS1CPP_results.txt', 'r') as archivo:
        lineas = archivo.readlines()
...
def getmSNFS2():
    # Abre el archivo de texto en modo lectura
    with open('mSNFS2CPP_results.txt', 'r') as archivo:
        lineas = archivo.readlines()
...
def performanceViewer():
    ...
    fig, ax = plt.subplots(3, 4)  # Crea una figura con dos subplots en una fila
